...
public class AndroidSplashActivity extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d("AndroidSplashActivity", String.format("onActivityResult %d %d", requestCode, resultCode));
        switch (requestCode) {
            case REQUEST_GAME:
                if (data != null) {
                ...
                break;
            default:
                Log.e("AndroidSplashActivity", String.format("onActivityResult unknown request:%d", requestCode));
        }
    }
